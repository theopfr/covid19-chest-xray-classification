...
class Model(nn.Module):
    def __init__(self, dropout_chance=0.0):
        ...
        self.avrgpool = nn.AvgPool2d(kernel_size=(9, 9))
    ...
    def forward(self, x, print_: bool=False, visualize: bool=False, return_fmaps: bool=False):
...
model = Model().cuda()
x = model.forward(x, print_=False)

m = list(model._modules()[-1].parameters())
print(m)
"""